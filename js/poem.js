// Array containing all lines of the poem
const poem = [
    "I found peace in restlessness.",
    "In cold I've found tenderness.",
    "In life I've found blood and sin.",
    "In death I've seen truth within.",
    "A thousand screams within me grin:",
    '"Let us free let one at least <span class="all-caps">WIN</span>"',
    "To no avail.",
    "As when you win…",
    "When freed your soul becomes from the shackles <span class=\"all-caps\">WITHIN</span>",
    "the chains broken",
    "the mind <span class=\"all-caps\">SPOKEN</span>",
    "the <span class=\"all-caps\">SOUL FLYING FREELY FINALLY FLOWING</span>",
    ".....",
    "....",
    "...",
    "..",
    ".",
    "All of us watch from the bottom just hoping.",
    "Just hoping that one day we too,",
    "we'd all",
    "<span class='final-win'>WIN</span>"
];
...
function safeGetElement(id) {
    ...
    if (!element) {
        handleError(`Element with id '${id}' not found`);
        return null;
    }
    return element;
}
